...
import TestimonialImg01 from "@/public/images/beija flor-01.jpg";
import TestimonialImg02 from "@/public/images/mariposa-02.jpg";
import TestimonialImg03 from "@/public/images/sanhaço-frade-03.jpg";
import TestimonialImg04 from "@/public/images/macaco-prego-04.jpg";
import TestimonialImg05 from "@/public/images/lebre-coelho-05.jpg";
import TestimonialImg06 from "@/public/images/capivara-06.jpg";
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.indigo.200),theme(colors.gray.50),theme(colors.indigo.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
            Espécies encontradas no Parque São José dos Pinhais
          </h2>
          <p className="text-lg text-indigo-200/65">
            Conheça um pouco mais sobre as Espécies
          </p>
        </div>

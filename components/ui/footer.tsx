  ...
  return (
    <footer>
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-6 justify-center gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-2 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-2 lg:grid-rows-1 xl:gap-20">
       
          {/* 3rd block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-200">Conteúdo</h3>
